...
router.post('/wars', requireAdmin, async (req, res, next) => {
  const body = req.body || {};
...
router.delete('/wars/:id', requireAdmin, async (req, res, next) => {
...
router.post('/capital', requireAdmin, async (req, res, next) => {
  const body = req.body || {};
  const memberId = positiveId(body.memberId);
...
router.delete('/capital/:id', requireAdmin, async (req, res, next) => {
  const id = positiveId(req.params.id);
